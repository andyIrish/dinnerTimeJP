...
public class ReceipeList {
	...
	//constructor
	ReceipeList(String name, String[] ingredients, int preptime) {
		this.name = name;
	...
	public void appendElement(String element)
	{
		...
		if(usedIndicies >= ingredients.length)
		{
			doubleArray();//calls double array if the userindicies is to big for the array
		}
		
		ingredients[usedIndicies] = element;
		usedIndicies++;
	}
	private void doubleArray()
	{
		String[] temp = new String[ingredients.length * 2];
